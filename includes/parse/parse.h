...
size_t get_max_line_length(char **input_data, size_t line_index,
                           size_t map_lines);
char get_char_at(char **input_data, size_t line_index, size_t row, size_t col);
int validate_map_size(char **input_data, size_t line_index, size_t map_lines,
                      size_t max_len);
...
const char *process_line(char ***map, int *lines, const char *start,
                         const char *end);
