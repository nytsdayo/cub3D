...
static int check_space_cell(const t_space_check_ctx *ctx, size_t i, size_t j);
static int check_all_adjacent(const t_space_check_ctx *ctx, size_t i, size_t j);
...
static int check_all_adjacent(const t_space_check_ctx *ctx, size_t i,
                              size_t j) {
