 ...
 */
__attribute__((unused)) static bool is_blank_line(const char *line) {
  (void)line;
  return (false);
}
 ...
 */
__attribute__((unused)) static int detect_identifier(const char *line) {
  (void)line;
  return (0);
}
 ...
 */
__attribute__((unused)) static char *extract_path(const char *line) {
  (void)line;
  return (NULL);
}
 ...
 */
__attribute__((unused)) static int parse_rgb(const char *line, t_color *color) {
  (void)line;
  (void)color;
  return (0);
}
...
all_identifiers_consumed(int seen_flags[6]) {
  (void)seen_flags;
  return (false);
}
...
handle_texture(const char *line, t_config_data *config, int seen_flags[6]) {
  (void)line;
  (void)config;
  (void)seen_flags;
  return (0);
 ...
 */
__attribute__((unused)) static int
handle_rgb(const char *line, t_config_data *config, int seen_flags[6]) {
  (void)line;
  (void)config;
  (void)seen_flags;
  return (0);
